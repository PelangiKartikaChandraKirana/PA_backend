...
<div class="px-6 py-6">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-800 tracking-tight">Tambah Tipe Dokumen</h1>
            <p class="mt-1 text-sm font-medium text-slate-500">Konfigurasi kategori dokumen baru untuk perizinan pegawai.</p>
        </div>
    ...
    <div class="max-w-4xl">
        <form action="{{ route('superadmin.master.tipe-dokumen.store') }}" method="POST" class="space-y-6">
            @csrf

            <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div class="border-b border-slate-100 bg-slate-50/50 px-6 py-4">
                    <h2 class="text-sm font-bold uppercase tracking-wider text-slate-600">Informasi Dokumen</h2>
                </div>
                ...
                <div class="p-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="category" id="category" 
                            ...
                            <option value="Tugas Luar" {{ old('category') == 'Tugas Luar' ? 'selected' : '' }}>Tugas Luar</option>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <span class="text-xs font-medium text-slate-500 italic">Gunakan warna berbeda untuk tiap kategori agar mudah diidentifikasi di kalender.</span>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm shadow-sm transition focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none"
                                  placeholder="Berikan penjelasan singkat tentang penggunaan dokumen ini...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 gap-4 md:grid-cols-3">
                        <label class="flex cursor-pointer items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50/50 p-4 transition hover:bg-white hover:shadow-md">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-500 leading-tight">Butuh validasi admin/atasan</p>
                            </div>
                        </label>

                        <label class="flex cursor-pointer items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50/50 p-4 transition hover:bg-white hover:shadow-md">
                            <input type="hidden" name="is_required" value="0">
                            <input type="checkbox" name="is_required" value="1" {{ old('is_required', 0) ? 'checked' : '' }}
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-500 leading-tight">Wajib upload bukti fisik</p>
                            </div>
                        </label>
                        ...
                        <label class="flex cursor-pointer items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50/50 p-4 transition hover:bg-white hover:shadow-md">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-500 leading-tight">Tersedia untuk dipilih pegawai</p>
                            </div>
                        </label>
                    </div>
                </div>
