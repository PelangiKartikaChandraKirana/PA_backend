...
<div class="px-6 py-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-800">Tambah Tipe Pegawai</h1>
        <p class="mt-1 text-sm text-slate-500">Isi data tipe pegawai dengan lengkap dan benar.</p>
    </div>

    <div class="max-w-4xl">
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-6 py-4">
                <h2 class="text-lg font-semibold text-slate-700">Form Tipe Pegawai</h2>
            </div>

            <form action="{{ route('superadmin.tipe-pegawai.store') }}" method="POST" class="p-6">
                @csrf
