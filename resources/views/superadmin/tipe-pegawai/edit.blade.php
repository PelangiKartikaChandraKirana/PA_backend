...
<div class="px-6 py-6">
    ...
    <div class="max-w-4xl">
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <form action="{{ route('superadmin.tipe-pegawai.update', $tipe_pegawai->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            name="name"
                            id="name"
                            value="{{ old('name', $tipe_pegawai->name) }}"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="code"
                            id="code"
                            value="{{ old('code', $tipe_pegawai->code) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm shadow-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                        >{{ old('description', $tipe_pegawai->description) }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="priority"
                            id="priority"
                            value="{{ old('priority', $tipe_pegawai->priority) }}"
                            placeholder="0"
                            class="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm shadow-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                        >
                        @error('priority')
                    ...
                    <div class="flex flex-col justify-end gap-4">
                        <label class="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
                            <input
                                ...
                                name="is_honorarium"
                                value="1"
                                {{ old('is_honorarium', $tipe_pegawai->is_honorarium) ? 'checked' : '' }}
                        ...
                        <label class="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
                            <input
                                ...
                                name="is_active"
                                value="1"
                                {{ old('is_active', $tipe_pegawai->is_active) ? 'checked' : '' }}
